...
const MyDocument = () => (
  <Document>
    <Page className="body" wrap>
      <Text className="title">Don Quijote de la Mancha</Text> <br />
      <Text className="author">Miguel de Cervantes</Text>
      <br />
      <Image className="image" src="./assets/download.png" />
      <br />
      ...
      <br />
      <Text className="emphasis">Instead of showing the title here</Text> <br />
      <Text className="subtitle" break>
        {" "}
        <br />
